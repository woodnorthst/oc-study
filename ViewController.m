...
- (void)viewDidLoad {
    ...
    m_timer = [NSTimer scheduledTimerWithTimeInterval:1 target:self selector:@selector(timerAction:) userInfo:nil repeats:YES];
...
-(void)timerAction:(NSTimer *)timer{
    ...
    int me_seconds = timerCount%1;
    
    int seconds = (timerCount/1)%60;

    int minutes = ((timerCount/1)/60)%60;
    
    int hour = ((timerCount/1)/60)/60;
